...
public class SpeedHUIS6 {
	...
	Map<Integer, ArrayList<Integer>> mapALL;
	...
	List<ArrayList<Integer>> itemsdata = new ArrayList<ArrayList<Integer>>();
	ArrayList<ArrayList<Integer>> frontitemsdata = new ArrayList<ArrayList<Integer>>();
	ArrayList<ArrayList<Integer>> frontitemsdata1 = new ArrayList<ArrayList<Integer>>();
	...
	//List<LinkedList<Integer>> HUIS = new LinkedList<LinkedList<Integer>>();
...
//	private int[] itemsetBuffer = null;
	...
	public class Pair{	
		ArrayList<ArrayList<Integer>> houxuanitemsdata1 = new ArrayList<ArrayList<Integer>>();
		ArrayList<Integer> houxuanitems = new ArrayList<Integer>();
	}
	static int min_utility;
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		String input = fileToPath("chess_unity.txt");
		String output = ".//output.txt";
	
		SpeedHUIS6 hauiminer = new SpeedHUIS6();
//		int totalnum =hauiminer.sumofdata(input);     
//       System.out.println(totalnum);
	    min_utility =600000;//(int)(2156659*0.2);//(int) (totalnum*0.1);  // 
			
	   try {
			hauiminer.runAlgorithm(input,output);
...
//			}
	...
	public void printStats() {
		System.out.println("=============  SPEEd HUI-MINER ALGORITHM - STATS =============");
